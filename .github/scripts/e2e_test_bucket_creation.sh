...
type: Opaque
stringData:
  COSI_DRIVER_S3_ACCESS_KEY_ID: PBUOB68AVF39EVVAFNFL
  COSI_DRIVER_S3_SECRET_ACCESS_KEY: P+PK+uMB9spUc21huaQoOexqdJoV00tSnl+pc7t7
  COSI_DRIVER_S3_ENDPOINT: http://$HOST_IP:8000
  COSI_DRIVER_S3_REGION: us-west-1
EOF
